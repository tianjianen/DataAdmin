export default [
  {
    path: '/data-search',
    name: 'DataSearch',
    component: (resolve) => require(['components/demo-components/datamanage/datasearch'], resolve),
    meta: { title: '数据查询' }
  },
  {
    path: '/data-config',
    name: 'DataConfig',
    component: (resolve) => require(['components/demo-components/datamanage/dataconfig'], resolve),
    meta: { title: '脱敏字段配置' }
  },
  {
    path: '/option-history',
    name: 'SQLOptionHistory',
    component: (resolve) => require(['components/demo-components/datamanage/optionhistory'], resolve),
    meta: { title: 'SQL操作记录' }
  },
  {
    path: '/form',
